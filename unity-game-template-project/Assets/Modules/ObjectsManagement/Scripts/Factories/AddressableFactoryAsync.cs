...
{
    public abstract class AddressableFactoryAsync<TComponent> : IDisposable
        where TComponent : Component
    {
        ...
        public AddressableFactoryAsync(AssetReference prefabReference, IAddressablesService addressablesService)
        {
